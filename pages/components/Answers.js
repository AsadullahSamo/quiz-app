              ...
              <div className="relative top-[34px] left-7 w-6 h-6 rounded-full inline-flex items-center justify-center bg-[#4a4fad] text-white font-bold"> {index + 1} </div> 
                <div ref={divRef} className={`bg-white rounded-md w-[95%] pl-10 pt-2 mx-5 mb-5 h-${divHeight}`}>
                  ...
                  <div className='flex gap-10'>
                    <p className={`text-left text-black text-[18px] font-bold w-[90%]`}> {question} </p>
                    <Image
                ...
                <div className='flex'>
                  { guessed[index] === 0 &&
                    <p className='text-[#b5666d] mt-5 font-semibold'> {wrongAns[index]} </p> 
                  }
                  <p className='-ml-10 text-green-500 mt-5 pl-[3.8rem] font-semibold'> {correctAns[index]} </p>
                </div>
              </div>
            </div>
          )
